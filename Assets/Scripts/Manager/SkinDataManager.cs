...
public class SkinDataManager : MonoBehaviour
{
    ...
    private Dictionary<string, SkinCustomerUpgradeType> _skinUpgradeTypeDic = new Dictionary<string, SkinCustomerUpgradeType>
    {
    ...
    {
        if (_skinUpgradeTypeDic.TryGetValue(typeStr, out SkinCustomerUpgradeType upgradeType))
        {
            return upgradeType;
        }
