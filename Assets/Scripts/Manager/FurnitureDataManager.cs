...
public class FurnitureDataManager : MonoBehaviour
{
    ...
    {
        return _furnitureDataListType[(int)type].Where(data => data.FloorType == floorType || data.FloorType == ERestaurantFloorType.None).ToList();
    }
    ...
    {
        var filteredList = _furnitureDataListType[(int)type].Where(data => data.FloorType == floorType || data.FloorType == ERestaurantFloorType.None).ToList();
