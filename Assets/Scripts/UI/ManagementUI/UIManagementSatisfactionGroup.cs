...
public class UIManagementSatisfactionGroup : UIManagementLayoutGroup
{
    ...
    {
        OnChangeStatisfactionEventNoAnime();
    }
    ...
    public override void Init()
    {
        ...
        _tmpSatisfaction = _satisfactionSystem.Satisfaction;
    ...
    private void OnChangeStatisfactionEventNoAnime()
    {
        _satisfactionImage.rectTransform.anchoredPosition = SatisfactionImagePosCaculator();
        _satisfactionText.SetText(((int)_satisfactionSystem.Satisfaction).ToString());
        CheckSatisfaction();
    }
