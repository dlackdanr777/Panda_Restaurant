...
public class Tutorial1 : MonoBehaviour
{
    ...
    private IEnumerator StartTutorial()
    {
        ...
        yield return _uiDescriptionNPC.ShowDescription2Text("역시 식당이라고 부르기 힘든 모습이네요.");
        ...
        yield return YieldCache.WaitForSeconds(1);
        _uiNav.Push("UITutorialDescription");
        yield return _uiDescriptionNPC.ShowDescription2Text("다음으로 음식을 조리하기 위해 조리 기구를 \n설치해 볼까요?");
        yield return _uiDescriptionNPC.ShowDescription2Text("주방 카테고리로 이동해 조리 기구를 \n구매해 주세요!");
        yield return YieldCache.WaitForSeconds(1);
        ...
        yield return YieldCache.WaitForSeconds(1);
        _uiNav.Push("UITutorialDescription");
        yield return _uiDescriptionNPC.ShowDescription2Text("잘하셨습니다! 손님을 맞이할 준비를 끝내셨네요!");
        ...
        yield return _uiDescriptionNPC.ShowDescription2Text("우측 하단에 있는 토루루는 손님을 불러 모을 수 있는 \n특별한 직원이랍니다.");
        ...
        yield return _uiDescriptionNPC.ShowDescription2Text("축하드려요. 점장님! 드디어 가게의 첫 번째 손님이네요!");
        ...
        yield return _uiDescriptionNPC.ShowDescription2Text("레시피를 배우지 않은 상태에선 \n주문을 받을 수 없습니다.");
        yield return _uiDescriptionNPC.ShowDescription2Text("모르는 레시피의 주문을 받으면 손님은 \n장난을 치는거라고 느끼겠죠?");
        _uiTutorial.ShopButtonSetActive(true);
        yield return _uiDescriptionNPC.ShowDescription2Text("불쾌해진 손님이 식당을 나가기전에 \n레시피를 배워봅시다!");
        yield return YieldCache.WaitForSeconds(1);
        _uiTutorial.ShopMaskSetActive(true);
        while (!_uiTutorial.IsButtonClicked)
            yield return YieldCache.WaitForSeconds(0.02f);
        ...
        yield return _uiDescriptionNPC.ShowDescription2Text("손님이 머물던 자리에 쓰레기도 치워줘야해요.");
